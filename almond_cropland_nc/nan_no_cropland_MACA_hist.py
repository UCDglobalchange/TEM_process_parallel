...
model = 'bcc-csm1-1'
period = '1950_1954'
nc_data = nc.Dataset('/group/moniergrp/MACA/MACA_mask_no_almond/macav2metdata_'+str(var_list[k])+'_'+str(model)+'_r1i1p1_historical_'+str(period)+'_CONUS_daily.nc', 'r+')
